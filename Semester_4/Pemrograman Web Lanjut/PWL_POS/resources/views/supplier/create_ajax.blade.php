        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="supplier_kode" name="supplier_kode" required>
                ...
                <div class="form-group">
                    <label>Alamat</label>
                    <textarea class="form-control" id="supplier_alamat" name="supplier_alamat" rows="3" required></textarea>
                    <small id="error-supplier_alamat" class="error-text form-text text-danger"></small>
                </div>
                <div class="form-group">
                    <label>Telepon</label>
                    <input type="text" class="form-control" id="supplier_telepon" name="supplier_telepon" required>
