-- Active: 1713241753104@@127.0.0.1@3306@jadwal_perkuliahan
-- phpMyAdmin SQL Dump
-- version 5.1.1
-- https://www.phpmyadmin.net/
--
-- Host: 127.0.0.1
-- Generation Time: May 09, 2023 at 04:21 AM
...
CREATE TABLE materi (
  kode_mk varchar(5) NOT NULL,
  kode_materi varchar(5) NOT NULL primary key,
  keterangan varchar(100) DEFAULT NULL,
  pertemuan INT
);

ALTER TABLE materi
  ADD CONSTRAINT `materi_fk_1` FOREIGN KEY (`kode_mk`) 
...
('02010', '00002', 'DML', 2),
('02010', '00003', 'DRL', 3),
('02030', '00004', 'Praktikum DDL', 1),
('02030', '00005', 'Praktikum DML', 2);
--
...
ALTER TABLE jadwal MODIFY kode_jadwal int(10) NOT NULL AUTO_INCREMENT;

ALTER TABLE JADWAL ADD FOREIGN KEY (kode_dosen) REFERENCES DOSEN(KODE_DOSEN),
...
ALTER TABLE KELAS ADD FOREIGN KEY(kode_prodi) REFERENCES PRODI(KODE_PRODI);
...
ALTER TABLE `jadwal`
  ...
  ADD CONSTRAINT `jadwal_ibfk_5` FOREIGN KEY (`jp_mulai`) REFERENCES `jp` (`kode_jp`),
  ADD CONSTRAINT `jadwal_ibfk_6` FOREIGN KEY (`jp_selesai`) REFERENCES `jp` (`kode_jp`),
  ADD CONSTRAINT `jadwal_ibfk_7` FOREIGN KEY (`kode_kelas`) REFERENCES `kelas` (`kode_kelas`);
...
SELECT MIN (jp_mulai) FROM jadwal;
...
SELECT * from jadwal WHERE kode_hari = 004;

SELECT count (kode_dosen) from jadwal where kode_hari = 002;

select kode_dosen from jadwal WHERE kode_hari = 002;
...
SELECT kode_ruang 
from jadwal WHERE kode_hari = 001 AND jp_mulai =1;



/*!40101 SET CHARACTER_SET_CLIENT=@OL;D_CHARACTER_SET_CLIENT */;
